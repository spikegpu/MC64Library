...
void
OldMC64::formBipartiteGraph(DoubleVectorD &d_c_val, DoubleVectorD &d_max_val_in_col)
{
...
void
OldMC64::initPartialMatch(DoubleVectorH& c_val,
						  DoubleVectorH& rowScale,
						  DoubleVectorH& colScale,
						  IntVectorH&    rowReordering,
						  IntVectorH&    rev_match_nodes,
