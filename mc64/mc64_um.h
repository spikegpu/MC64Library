...
// -----------------------------------------------------------------------------
// MC64 algorithm using unified memroy (requires CUDA >= 6.0)
// -----------------------------------------------------------------------------
...
public:
  MC64_UM(const IntVector&    row_offsets,
...
void
MC64_UM::formBipartiteGraph(DoubleVector &c_val,
                            DoubleVector &max_val_in_col)
{
...
void
MC64_UM::initPartialMatch(DoubleVector& c_val,
                          DoubleVector& rowScale,
                          DoubleVector& colScale,
                          IntVector&    rowReordering,
                          IntVector&    rev_match_nodes,
...
void
MC64_UM::findShortestAugPath(int            init_node,
                             BoolVector&    matched,
                             BoolVector&    rev_matched,
                             IntVector&     match_nodes,
                             IntVector&     rev_match_nodes,
